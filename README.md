...
# **quick-http-server** :<br> a quick command-line http server
...
![](https://github.com/sparksystems/quick-http-server/raw/master/screenshots/public.png)
